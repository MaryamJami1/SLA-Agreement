...
// Phase 3 edits drafts only; amendments of confirmed bookings arrive with Phase 4.
$editable = $booking === null || (booking_allows($booking, $viewer, 'edit') && $booking['status'] === 'draft');
